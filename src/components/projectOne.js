...
const projectOne = (props) => {
    return (
        <>
            <div id="copyheader">
                <div id="copylabel"><h2>Portfolio</h2></div>
                <div style={{display: 'flex'}}>
                <Link>
                        <div className={`homebutton ${props.theme}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class={`bi bi-git headericon ${props.theme}`} viewBox="0 0 16 16">
                    ...
                    <Link id="home" to="/">
                        <div className={`homebutton ${props.theme}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" class={`bi bi-house-door headericon ${props.theme}`} viewBox="0 0 16 16">
